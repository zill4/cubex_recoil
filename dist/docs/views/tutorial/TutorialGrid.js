...
var TutorialTable = (function (_super) {
    ...
    TutorialTable.prototype.render = function () {
        ...
        var colTemplate = function (item, index) {
            return React.createElement(index_1.Layer, { theme: "light", fill: true, border: true, flexCenter: true }, item.name);
        };
        var example = function () {
            return (React.createElement("div", null,
                React.createElement(index_1.Grid, { margin: "20px", className: "mb20", rows: [{ columns: [1, 1, 1, 1, 1], height: '200px', template: colTemplate.bind(_this) }], dataSource: TableProperties }),
                React.createElement(index_1.Grid, { className: "mb20", margin: "20px", rows: [
                        { columns: [1], height: '400px', template: colTemplate.bind(_this) },
                        { columns: [1, 1], height: '200px', template: colTemplate.bind(_this) },
                        { columns: [1], height: '400px', template: colTemplate.bind(_this) },
                        { columns: [1, 1, 1, 1], height: '200px', template: colTemplate.bind(_this) },
                    ], dataSource: TableProperties }),
                React.createElement(index_1.Grid, { margin: "20px", rows: [{ columns: [1, 1, 1, 1, 1], height: '200px', template: colTemplate.bind(_this) }], dataSource: TableProperties })));
        };
